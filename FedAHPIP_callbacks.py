"""
Customize the inbound and outbound processors for FedAHPIP clients through callbacks.
"""

import FedAHPIP_utils
...
class ModelEstimateProcessor(base.Processor):
    ...
    def process(self, data: Any) -> Any:
        FedAHPIP_utils.update_est(Config(), self.client_id, data)
        return data


class FedAHPIPCallback(ClientCallback):
    """
